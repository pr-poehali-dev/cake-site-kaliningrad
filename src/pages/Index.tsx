...
const catalog = [
  ...
  { id: 4, name: "Медовик", price: "2 500 ₽/кг", emoji: "🍯", tag: "", desc: "Классический медовый торт с нежным сметанным кремом" },
  { id: 5, name: "Трюфели", price: "150 ₽/шт", emoji: "🍫", tag: "", desc: "Бельгийский шоколад, насыщенная начинка, ручная лепка" },
...
const services = [
  ...
  { icon: "Star", title: "Мастер-классы", desc: "Научу готовить торты и десерты у вас дома или онлайн" },
  { icon: "Truck", title: "Доставка по Калининграду", desc: "Привезём ваш заказ в удобное время по всему городу" },
  { icon: "Camera", title: "Оформление фотозон", desc: "Candy bar и десертные столы для свадеб и банкетов" },
];
...
const faqs = [
  ...
  { q: "За сколько дней нужно оформить заказ?", a: "Торты — минимум за 3–5 дней. Капкейки и макаруны — за 1–2 дня. В праздничные сезоны рекомендую бронировать за 1–2 недели." },
  { q: "Есть ли доставка?", a: "Да, доставляю по всему Калининграду. Стоимость зависит от района. Самовывоз тоже доступен." },
